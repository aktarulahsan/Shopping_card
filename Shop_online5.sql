...
INSERT INTO `category` (`cat_id`,`cat_name`,`cat_desc`) VALUES 
 (1,'womens fashion','womens fashion'),
 (2,'mens fashion','mens fashion');
...
INSERT INTO `product` (`pro_id`,`sub_cat_id`,`pro_name`,`pro_qty`,`pro_price`,`pro_url`,`pro_desc`) VALUES 
 (1,1,'Moccasin and Maroon Georgette Saree',1,1800,'Moccasin and Maroon Georgette Saree.jpg','Moccasin and Maroon Georgette Saree for Women'),
 (2,1,'Red and Navy Blue Georgette Saree',1,1950,'Red_and_Navy Blue_Georgette_Saree.jpg','luxurious and colorful sarees'),
 (3,4,'White Cotton Long Sleeve Shirt',1,799,'White_Cotton Long_Sleeve_Shirt.jpg','White Cotton Long Sleeve Shirt for Men'),
 (4,4,'Deep Blue Cotton Shirt for Men',1,590,'Deep_Blue_Cotton_Shirt_for_Men.jpg','Big Bang Fashion is one of the popular brands for all type of products at reasonable price. They provide us with a different type of products very frequently. Shop your choice from this seller!');
...
INSERT INTO `sub_category` (`sub_cat_id`,`cat_id`,`sub_cat_name`,`sub_cat_desc`) VALUES 
 (1,1,'saree','Saree for Women'),
 (2,1,'Salwar Kameez','Salwar Kameez for Women'),
 (3,1,'women-pants','nice women-pants for women'),
 (4,2,'mens-shirts','shirts for mens'),
 (5,2,'men-jackets-coats','jackets-coats for mens');
